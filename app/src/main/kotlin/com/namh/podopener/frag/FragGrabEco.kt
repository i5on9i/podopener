...
class FragGrabEco : Frag() {
    ...
    fun onButtonPressed(uri: Uri) {
        if (mListener != null) {
            mListener!!.onFragGrabEcoInteraction(uri)
        }
    }
    ...
    interface OnFragmentInteractionListener {
        ...
        fun onFragGrabEcoInteraction(uri: Uri)
    }

    companion object {

        private val podUrl = "http://minicast.imbc.com/PodCast/pod.aspx?code=1000671100000100000"
        private val podName = "grabeco"
